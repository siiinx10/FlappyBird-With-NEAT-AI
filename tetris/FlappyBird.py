...
class Bird:
    ...
    def move(self):
            ...
            if d >= 16:
                #terminal displacement for 16 pixel which is outside screen
                d = 16
...
def main():
    ...
    while run:
        ...
        for pipe in pipes:
            ...
            #Position of the pipeto be removed that are off the screen
            if pipe.x + pipe.PIPE_TOP.get_width() < 0:
                rem.append(pipe)


            #Checkes if we have passed the pipe, we need to generate a new one
